...
<head>
  ...
  <title>Daftar Mahasiswa - Pascasarjana Universitas Galuh</title>
                  ...
                  <tbody>
                    <?php $no = 1; foreach ($users as $user) :?>
                      <tr>
                        ...
                        <td class="text-center"><a class="text-info" data-id="<?php echo $user->id;?>">Ubah</a> <a class="text-danger" href="<?php echo base_url('users/hapus/mahasiswa/').$user->id;?>">Hapus</a></td>
                      </tr>
                    <?php endforeach;?>
                  </tbody>
                </table>
