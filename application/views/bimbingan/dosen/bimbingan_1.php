      ...
      <div class="container-fluid">
              ...
              <tbody id="pengajuan">
                ...
                ?>
                  <tr>
                    ...
                    <td class="text-center align-middle">
                    	<a href="<?php echo base_url('bimbingan/bimbingan/1/').$bimbingan["id_bimbingan"].'/'.$bimbingan["bab"].'/'.$bimbingan["id_pengajuan"];?>"class="detail-bimbingan text-info" data-id="<?php echo $bimbingan["id_bimbingan"];?>">Detail</a>
                    </td>
                  </tr>
                <?php endforeach;?>
              </tbody>
        ...
        <div class="modal fade" id="modal-cetak">
          <div class="modal-dialog modal-md">
            <div class="modal-content">
              <?php echo form_open('bimbingan/cetak_dosen/1');?>
              <div class="modal-header">
